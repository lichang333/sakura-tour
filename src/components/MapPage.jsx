...
function buildPopup(spot, status, onView) {
  ...
  el.innerHTML = `
    ...
    <div class="mp-badge ${status}">${status === 'visited' ? '✈️ 去过' : '♡ 想去'}</div>
  ...
  return (
    <div className="map-page">
      <div className="map-header">
        <h2 className="page-title">我的地图 🗺️</h2>
        <p className="page-sub">想去和去过的地方，一眼看清</p>
      </div>
      ...
      <div className="map-card">
        ...
        <div className="map-legend">
          <span className="ml-item"><span className="ml-dot visited" />去过</span>
      ...
      <div className="map-list-section">
        {visible.length === 0 ? (
          <div className="empty-spots">
            ...
            <span>还没有「想去」或「去过」的地方<br />在景点页面收藏或打卡后，会出现在地图上</span>
          </div>
        ) : (
