...
const dehongSpots = [
  ...
  },
  {
    ...
    ticket: "门票约50元",
    description: "瑞丽近郊的一片原始热带雨林，沿溪徒步约半小时，尽头是从崖顶飞泻六十余米的莫里瀑布，水气蒸腾、彩虹时现。林中古木参天、藤萝缠绕，还有相传释迦牟尼留下脚印的圣迹，清凉幽静。",
  ...
  },
  {
    ...
    ticket: "免费",
    description: "瑞丽东郊的傣族古佛塔群，始建于数百年前、屡毁屡建，是德宏最负盛名的佛塔之一。金黄主塔高近四十米、十六座小塔簇拥，塔尖风铃在风中叮当作响。是当地傣族重要的礼佛之地，庄严而清净。",
...
const qujingTips = [
  { icon: "🌻", title: "油菜花季", content: "罗平油菜花约2-3月盛开，罗平国际油菜花文化旅游节通常2月下旬开幕，是曲靖一年最旺的时节。看日出花海要6点前上金鸡峰丛观景台占位；花季人多路堵、食宿紧张，务必早订、早出发。" },
...
const singaporeItinerary = [
  {
    ...
    activities: [
      ...
      { time: "晚上", icon: "🎆", text: "国庆季：旧机场路熟食中心晚饭→丹戎禺看体育场烟花" },
    ]
  },
  {
...
const singaporeTips = [
  { icon: "🎆", title: "国庆烟花攻略", content: "国庆日 8月9日晚 NDP 庆典尾声放烟花。据官网 NDP 2026 主会场设在加冷·国家体育场（61周年，主题 Go Beyond!），烟花在体育场一带上空——免费机位首选丹戎禺步道（隔加冷湾正对，有水面倒影）与体育场滨水步道；国庆前数周的周六预演同样放烟花、人少好占位。提前 1.5-2 小时到，散场 Stadium 站限流需耐心。详见首页「国庆日烟花秀」限定卡。" },
...
export const CITIES = [
  ...
  },
  {
    ...
    specialEvent: {
      emoji: '🎆',
      name: '国庆日烟花秀',
      date: '8月9日正日 · 7/25、8/1 预演同放烟花',
      place: '加冷·国家体育场一带上空（NDP 2026 主会场）',
      desc: '61周年国庆庆典「Go Beyond!」尾声放烟花，丹戎禺步道/体育场滨水步道免费机位最佳',
      from: '07-15', to: '08-09',
      spotId: 'sin1',
      guide: {
        venue: {
          name: "主会场：加冷 Kallang · 国家体育场",
          desc: "加冷在市区东北侧、加冷河汇入海湾处，是新加坡的「体育城」（Sports Hub）：55,000 座的国家体育场（可开合穹顶）、室内体育馆、水上中心与 Kallang Wave Mall 连成一片。NDP 2026 主会场就设在这里，压轴烟花从体育场一带升空——场外加冷湾一圈免费可看。",
          points: [
            "🚇 地铁环线 Stadium 站出站即达；东西线 Kallang 站步行约 12 分钟",
            "🎫 场内观礼需抽票（本地为主）；场外看烟花完全免费",
            "🕓 演出日 16:30 开门；当晚 Stadium 站限流，提早到或绕行 Mountbatten 站",
            "🌊 加冷湾水面开阔无遮挡，对岸丹戎禺步道是烟花+倒影的最佳免费机位",
          ],
        },
        intro: "国庆庆典 NDP 是新加坡一年最大的盛事：战机拉烟、红狮跳伞、万人观礼，烟花点亮夜空。NDP 2026（61周年，主题「Go Beyond!」）主会场在加冷国家体育场，场外围观完全免费。2026 烟花日：7/11、7/18 彩排，7/25、8/1 预演，8/9 正日——每场都放烟花，且据实测烟花分两波：约 19:30-40 第一波大烟花，20:10-30 主烟花压轴。实测预演已现人潮与交通管制，建议 18 点前到场占位。",
        timeline: [
          { time: "18:00", text: "建议到场占位——实测预演已人潮+交通管制，正日只会更挤" },
          { time: "18:40", text: "飞行表演、直升机挂国旗巡游" },
          { time: "18:50", text: "21 响礼炮" },
          { time: "19:00", text: "Fire of Joy 礼花枪炮" },
          { time: "19:30", text: "🎆 第一波大烟花（约 19:30-19:40）" },
          { time: "20:10", text: "🎆 主烟花压轴（约 20:10-20:30，越近正日时间越准）" },
          { time: "20:45", text: "散场高峰：Stadium 站限流，沿加冷湾散步半小时再走" },
        ],
        viewpoints: [
          { name: "丹戎禺步道 Tanjong Rhu Promenade", stars: 3, lat: 1.2975, lng: 103.8745,
            pros: "直面体育场，烟花+水面倒影同框，无需广角就拍得全",
            cons: "吊桥位置尤其热门，去晚只剩侧位",
            tip: "TE23 Tanjong Rhu 站 B 口出，带野餐垫提前 1.5-2 小时" },
          { name: "Kallang Basin 观景台 Lookout Deck", stars: 3, lat: 1.3080, lng: 103.8655,
            pros: "离烟花很近、氛围感最强，周围草坪适合举家野餐（本地人隐藏点）",
            cons: "太近了，拍全烟花必须超广角镜头",
            tip: "CC9 Nicoll Highway 站 B 口往 Republic Ave" },
          { name: "体育场滨水步道 Stadium Riverside Walk", stars: 3, lat: 1.3025, lng: 103.8720,
            pros: "距体育场最近的第一排观赏位",
            cons: "人也最多，部分区域或被管制",
            tip: "CC6 Stadium 站 A 口出；听现场指引别钻围栏" },
          { name: "Kallang Wave 商场外广场", stars: 2, lat: 1.3035, lng: 103.8740,
            pros: "体育场脚下，有吃有喝有厕所，带娃友好",
            cons: "视角仰头、建筑遮挡部分低空烟花",
            tip: "商场里吹冷气等到 19:30 再出来占位" },
          { name: "滨海堤坝 Marina Barrage（传统热门）", stars: 2, lat: 1.2804, lng: 103.8714,
            pros: "旅游局官方推荐的国民看烟花胜地，大草坪野餐氛围最好",
            cons: "2026 主秀在加冷体育场，湾区是否同步放烟花以当年节目单为准",
            tip: "确认当年设湾区烟花点再来，那它就是最从容的机位" },
          { name: "尼诰大道大草坪 Nicoll Highway 侧", stars: 2, lat: 1.2995, lng: 103.8660,
            pros: "加冷湾与市区天际线之间，退可看城景",
            cons: "距离稍远，烟花偏小",
            tip: "摄影党拉长焦拍烟花+高楼同框" },
          { name: "滨海东花园 Gardens by the Bay East", stars: 3, lat: 1.2900, lng: 103.8770,
            pros: "湾口滨水草坪北望体育场，水面全开阔、本地人野餐地、游客罕至",
            cons: "地铁不直达（Tanjong Rhu 站步行），设施少",
            tip: "自备餐垫零食，比丹戎禺更松弛的选择" },
          { name: "加冷河滨公园 Kallang Riverside Park", stars: 2, lat: 1.3095, lng: 103.8680,
            pros: "空间大、不拥挤，适合怕挤人群",
            cons: "角度偏侧后方",
            tip: "EW11 Lavender 站 A 口往 Crawford St" },
          { name: "Kallang 草地滚球场 Lawn Bowl", stars: 2, lat: 1.3025, lng: 103.8765,
            pros: "距离稍远、人相对较少",
            cons: "视角一般",
            tip: "Stadium 站出站往 Stadium Boulevard" },
          { name: "Beach Road 组屋走廊（摄影位）", stars: 2, lat: 1.3005, lng: 103.8635,
            pros: "空中视角、人不多，通常只有摄影爱好者提前占位",
            cons: "居民楼公共走廊，务必安静勿扰民",
            tip: "Nicoll Highway/Lavender 站；轻声、别堵通道" },
          { name: "Pine Close 组屋（城市夜景机位）", stars: 2, lat: 1.3080, lng: 103.8800,
            pros: "体育场背面高位，以 CBD 天际线为背景拍烟花，标准城市夜景片",
            cons: "机位很少，需早占；勿扰民",
            tip: "Mountbatten 站步行；摄影党专属" },
          { name: "新加坡摩天观景轮 Flyer（付费）", stars: 2, lat: 1.2893, lng: 103.8631,
            pros: "165 米高空俯瞰烟花+全城，独一份视角（约S$40/30分钟一圈）",
            cons: "要卡准 20:00 前后登舱，排队易错峰",
            tip: "提前购票、19:30 前到场排队" },
        ],
        bayPoints: [
          "鱼尾狮公园 Merlion Park", "螺旋桥 Helix Bridge", "滨海东花园 Bay East Garden",
          "滨海堤坝 Marina Barrage", "The Lawn @ Marina Bay", "Clifford Square",
          "The Promontory", "滨海艺术中心海滨长廊", "Marina Square Rooftop（隐藏机位）",
          "Boat Quay 河畔（可边晚餐边看）",
        ],
        dinner: [
          { name: "Kallang Wave Mall 食阁", walk: "电梯下楼 → 体育场脚下", desc: "开饭最近的选择，国庆晚人多要早吃" },
          { name: "旧机场路熟食中心", walk: "打车 6 分钟 → 丹戎禺步道", desc: "米其林推荐摊位扎堆的老牌小贩中心，本地人心中 Top 级" },
          { name: "加东叻沙一带", walk: "打车 10 分钟 → 加冷湾", desc: "328 叻沙+娘惹菜提前吃，顺路看彩色骑楼" },
        ],
        restaurants: [
          { name: "Boat Quay 河畔餐厅带（实测推荐）", dist: "沿河望烟花", lat: 1.2872, lng: 103.8498,
            view: "本地实测：可以边吃晚餐边赏烟花，新加坡河夜景打底",
            note: "选沿河露天座，订位时报「要看 NDP 烟花的位置」；海鲜/酒吧餐厅密集任选" },
          { name: "Kallang Wave Mall 临湾露天座", dist: "体育场脚下", lat: 1.3035, lng: 103.8745,
            view: "近距离仰看，部分座位有遮挡",
            note: "国庆晚露天座靠抢，17点前落座才稳；吃完出门就是机位" },
          { name: "CÉ LA VI（金沙57层天台）", dist: "约2.9km 远眺", lat: 1.2834, lng: 103.8607,
            view: "高空东北向可望加冷上空，烟花较小但全城夜景打底",
            note: "订前先邮件确认「体育场方向烟花可见吗」再下单（SKAI 已官方承认看不到，高空餐厅都别想当然）；官网 SevenRooms/邮件直订，备注东北朝向；北塔 Tower 3 专梯直上57层" },
          { name: "SKAI（史丹福瑞士酒店70层）", dist: "⚠️ 官方：看不到", lat: 1.2931, lng: 103.8535,
            view: "餐厅官方声明：国庆在体育场举办，店内用餐看不到烟花",
            note: "适合改为非烟花日的纯夜景晚餐（4道套餐$218++，48小时内取消每人收$80++）" },
          { name: "Level33（金融中心33层精酿餐厅）", dist: "约3.2km 远眺", lat: 1.2793, lng: 103.8543,
            view: "露台向北视角，部分被高楼遮挡",
            note: "订前电话确认加冷方向烟花可见再来，被高楼遮挡风险不小" },
        ],
        faqs: [
          { q: "要买票吗？", a: "不用买——NDP 门票不发售，场内观礼票是免费抽签（Ballot），且基本只对新加坡公民/PR 开放；游客想进场只能碰官网社媒的赠票活动。但看烟花完全不需要票：烟花在体育场上空绽放，本攻略所有机位都在场外、全部免费，预演场同理。" },
          { q: "有能边吃边看的餐厅吗？", a: "谨慎。体育场年份连 SKAI（70层）都官方声明店内看不到烟花——高空餐厅的视线极易被楼群遮挡。订任何「观景晚餐」前务必先问餐厅「能否看到体育场方向的烟花」。最稳的仍是：附近吃完，走进免费机位。" },
          { q: "预演日也有烟花吗？", a: "国庆前数周的周六 NDP 预演傍晚多有烟花，规模略小但人少很多，是捡漏首选。" },
          { q: "下雨怎么办？", a: "小雨通常照放。备一次性雨衣——撑伞挡后排视线，很招嫌。" },
          { q: "怎么占位最地道？", a: "跟本地人学「chope」：铺野餐垫或放一包纸巾就代表此位有主。早去铺垫，人再去附近溜达等开场。" },
          { q: "散场地铁挤吗？", a: "Stadium 站当晚限流严重。要么沿加冷湾多待半小时，要么步行到 Mountbatten/Nicoll Highway 站再上车。" },
        ],
      },
    },
    quickTips: [
