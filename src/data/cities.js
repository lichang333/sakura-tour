  ...
  },
  {
    ...
    specialEvent: {
      ...
      guide: {
        ...
        intro: "国庆庆典 NDP 是新加坡一年最大的盛事：战机拉烟、红狮跳伞、万人观礼，压轴烟花点亮夜空。据官网，NDP 2026（61周年，主题「Go Beyond!」）主会场设在加冷的国家体育场，演出日 16:30 开门——烟花在体育场一带上空绽放，场外围观完全免费。国庆前数周的周六傍晚多有预演（同样放烟花，人少很多）。体育场年份滨海湾是否设同步烟花点，以当年官方节目单为准。",
        timeline: [
          { time: "15:00", text: "体育场周边陆续管制，地铁 Stadium 站人流管控——全程步行思维" },
          { time: "17:30", text: "就近晚饭（见下方动线），吃饱喝足再进机位" },
          { time: "18:30", text: "抵达加冷湾一带机位铺垫占位，看战机彩排掠过" },
          { time: "20:00", text: "庆典进入尾声——好戏将至" },
          { time: "20:10", text: "🎆 压轴烟花约 10-15 分钟（具体以当年节目单为准）" },
          { time: "20:45", text: "散场高峰：Stadium 站限流，沿加冷湾散步半小时再走" },
        ],
        viewpoints: [
          { name: "丹戎禺步道（加冷湾对岸）", stars: 3, lat: 1.2975, lng: 103.8745,
            pros: "隔水正对体育场，烟花+水面倒影同框，本地人私藏机位",
            cons: "无地铁直达，需打车或从 Mountbatten 站步行",
            tip: "带上野餐垫，提前 1.5 小时到即可" },
          { name: "体育场滨水步道 Stadium Riverside", stars: 3, lat: 1.3025, lng: 103.8720,
            pros: "离烟花最近、头顶绽放，散场并入地铁最快",
            cons: "当天人最密，部分区域或被管制",
            tip: "听现场工作人员指引，别钻围栏" },
          ...
          { name: "加冷河滨公园 Kallang Riverside", stars: 2, lat: 1.3095, lng: 103.8680,
            pros: "体育场西北隔河相望，人少开阔，散场走 Kallang 站不挤",
            cons: "角度偏侧后方",
            tip: "怕人挤选这里，牺牲一点角度换清净" },
